...
var poly = require(`../data/london_poly.json`);

// first location is depot
var numberDestinations = 10;
var precision = 4;
...
// NOW time planning - should change to some future time if planning
var bodyRequest = {
